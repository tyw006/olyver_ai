...
# conda uninstall torch, pytorch
# pip uninstall torch, torchvision, torchaudio
# Use conda since we are in conda environment
...
def detect(videoPath):
  ...
  foi = {'lift_start': lift_start_frame, 'lift_end': lift_end_frame}
  foi_instances = {}
  def lift_segmenter():
  ...
  def lift_velocity(frames_coordinates):
    lift_points = ['lift_start','initial_pull','power_position', 'max_bar_height','catch','lift_end']
    velocities = {}
